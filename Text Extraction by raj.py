...
root.title('TEXT EXTRACTION FROM MULTI-MEDIA DEVELOPED BY TEAM RCS')
root.resizable(0, 0)
meaning = ''
...
rrimage = PhotoImage(file='rr.png')
cbimage = PhotoImage(file='cb.png')
...
def peptxt():
    ...
    newWindow.title("TEAM RCS")
    newWindow.geometry("600x550")
    Label(newWindow, text="Team members", font=('castellar', 20, 'bold'), fg='red3',bg='whitesmoke').pack()

    Label1 = Label(newWindow, text='R.Revanth Raj         \n Reg.no : 9920004109', font=('castellar', 15, 'bold'), fg='red3',
                   bg='whitesmoke')
    Label1.place(x=200, y=100)

    Label1 = Label(newWindow, text='T.Chaithanya Bharathi\n Reg.no : 9920004152', font=('castellar', 15, 'bold'), fg='red3',
                   bg='whitesmoke')
    Label1.place(x=200, y=250)

    Label1 = Label(newWindow, text='P.Shashank             \n Reg.no : 9920004160', font=('castellar', 15, 'bold'), fg='red3',
                   bg='whitesmoke')
...
def imgtxt():
    newWindow = Toplevel(root)
    newWindow.title("IMAGE TO TEXT CONVERSION - DEVELOPED BY TEAM RCS")
...
def videotxt():
    newWindow = Toplevel(root)
    newWindow.title("VIDEO TO TEXT CONVERSION - DEVELOPED BY TEAM RCS")
    newWindow.geometry("900x600")
...
def audiotxt():
    newWindow = Toplevel(root)
    newWindow.title("AUDIO TO TEXT CONVERSION - DEVELOPED BY TEAM RCS")
    newWindow.geometry("900x600")
